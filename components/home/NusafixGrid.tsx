          ...
          {nosafixTools.map((tool) => {
            ...
            return (
              <motion.div key={tool.nameKey} variants={itemVariants} className="flex">
                <Link to={tool.path} className="flex flex-col w-full rounded-xl shadow h-full hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 bg-white dark:bg-gray-800 border border-secondary/20 dark:border-accent/20 cursor-pointer">
