export const translations = {
  he: {
    ...
    myEmojiGridDesc: 'העלה, נהל, חפש, והוסף אימוג\'ים מותאמים אישית משלך לצ\'אטים, מיילים, רשתות חברתיות ועוד. כולל אפשרות הסרת רקע מתקדמת!',
    ...
    cutfixPageTitle: 'מסיר רקעים חכם',
    ...
    cutfixApiTitle: 'Cutfix - API להסרת רקע',
    ...
    templeTimerDesc: 'הוסיפו לאתר שלכם ווידג\'ט דינמי המציג את הזמן שחלף מאז חורבן בית המקדש השני.',
    livePreview: 'תצוגה מקדימה חיה',
    embedCode: 'קוד להטמעה',
    embedInstructions: 'כדי להטמיע את הטיימר באתר שלכם, פשוט העתיקו והדביקו את קוד ה-HTML הבא:',
    customization: 'התאמה אישית',
    customizationDesc: 'ניתן לשנות את הגודל של החלונית על ידי שינוי הערכים `width` (רוחב) ו-`height` (גובה) בקוד ה-iframe.',
    credits: 'קרדיטים ורישיון',
    creditsDesc: `הווידג'ט משתמש בספריית JavaScript חיצונית ומפורסם תחת רישיון MIT.`,
...
תודה על השימוש ב"פותחן Edge"!`,
  ...
  en: {
    ...
    cutfixPageTitle: 'Smart Background Remover',
    ...
    cutfixApiTitle: 'Cutfix - Background Removal API',
    ...
    templeTimerDesc: 'Add a dynamic widget to your site that displays the time elapsed since the destruction of the Second Temple.',
    livePreview: 'Live Preview',
    embedCode: 'Embed Code',
    embedInstructions: 'To embed the timer on your site, simply copy and paste the following HTML code:',
    customization: 'Customization',
    customizationDesc: 'You can change the size of the widget by modifying the `width` and `height` values in the iframe code.',
    credits: 'Credits & License',
    creditsDesc: 'The widget uses an external JavaScript library and is released under the MIT License.',
